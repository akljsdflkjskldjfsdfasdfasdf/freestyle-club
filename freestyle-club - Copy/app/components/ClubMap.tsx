  ...
  return (
    ...
    >
      ...
      <div className="grid items-start gap-8 lg:grid-cols-[1fr_280px]">
        {/* Skica */}
        <div className="map-reveal panel min-w-0 rounded-3xl p-4 sm:p-6">
          <p className="mb-2 text-center text-[11px] uppercase tracking-widest text-white/40 sm:hidden">
            Prevuci tlocrt levo / desno ↔
          </p>
          {/* Na mobilnom mapa je šira od ekrana i skroluje se horizontalno
              (da nazivi separea budu čitljivi); od sm naviše staje normalno. */}
          <div className="-mx-2 overflow-x-auto px-2 pb-2 sm:mx-0 sm:overflow-x-visible sm:px-0 sm:pb-0">
            <svg
              className="club-svg h-auto w-full min-w-[34rem] sm:min-w-0"
              viewBox="0 0 820 520"
              role="group"
        ...
        {/* Legenda */}
        <div className="map-reveal panel min-w-0 rounded-3xl p-6">

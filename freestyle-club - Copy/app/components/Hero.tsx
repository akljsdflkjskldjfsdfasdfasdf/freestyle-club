  ...
  useGSAP(
    () => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        gsap.to(".hero-word", {
          textShadow: "0 0 0.5em #ff4fd8, 0 0 1.7em rgba(168,85,247,0.75)",
          repeat: -1,
          yoyo: true,
          duration: 2.4,
          ease: "sine.inOut",
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <span
          ...
          style={{ background: "var(--color-neon-cyan)", animationDelay: "-6s" }}
        />
        <span
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <h1
          className="hero-word hero-title font-display text-[clamp(3rem,16vw,11rem)] font-extrabold leading-[0.9] tracking-tight text-white"
          style={{
        ...
        <p className="hero-slogan mt-6 max-w-xl text-balance text-base text-white/75 sm:text-lg">
          {siteConfig.tagline} — House, RnB, Hip-Hop &amp; Disco. Preko 10 godina
          najjačeg provoda na vodi.
        </p>

...
export default function ReservationProvider({
  ...
  return (
    <ReservationContext.Provider value={{ open }}>
      ...
      {isOpen && activeType && (
        <div
          className="animate-fade-in fixed inset-0 z-[70] flex items-end justify-center overflow-y-auto bg-ink/80 p-0 backdrop-blur-sm sm:items-center sm:p-6"
          onClick={close}
          role="dialog"
          aria-modal="true"
        ...
        >
          <div
            className="animate-pop-in panel relative w-full max-w-lg rounded-t-3xl border-white/10 p-6 sm:rounded-3xl sm:p-8"
